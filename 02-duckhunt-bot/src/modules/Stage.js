import { Point, Graphics, Container, Sprite } from "ixi.js";

import BPromise from "luebird";
import { some as _some } from "odash/collection";
import { delay as _delay } from "odash/function";
import { inRange as _inRange } from "odash/number";
...
class Stage extends Container {
   ...
   */
  _setStage() {
    const background = new Sprite(this.textures["cene/back/0.png"]);
    background.position.set(0, 0);

    const tree = new Sprite(this.textures["cene/tree/0.png"]);
   ...
   * @param {Number} radius - The 'last radius'of the player's weapon
   ...
   * is that even dead ducks may be animating and still 'ctive'   * @returns {Boolean}
   */
  ducksAlive() {
